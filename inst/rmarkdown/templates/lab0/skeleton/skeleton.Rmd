...
Try each method on this following chunk (remember, R can be used as a big calculator):
...
**Task 2**: Comment the `arbuthnot` line so that when you "knit" the document to an html output, the whole dataset will not be printed.
